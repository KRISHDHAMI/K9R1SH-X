#!/usr/bin/python
#Original written By Krish Dhami
...
import os, requests, re,platform, sys, random, subprocess, threading, itertools,base64,uuid,zlib,re,json,uuid,subprocess,-
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +krish)
    os.system('sort -r '+ssb+' | uniq > '+krish)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + krish )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
